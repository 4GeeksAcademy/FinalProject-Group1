...
RECIPES_DATA = [
    ...
    {"title": "Guacamole Fresco", "steps": "1. Machacar aguacates\n2. Picar cebolla y tomate\n3. Añadir limón y cilantro\n4. Sazonar", "image": "https://images.unsplash.com/photo-1541288097308-7b8e3f76ff55?w=600&q=80", "difficulty": difficultyEnum.EASY, "prep_time": 10, "portions": 4, "ingredients": [("Aguacate", 3, "unidades"), ("Tomate", 1, "unidades"), ("Cilantro", 20, "g")]},
    ...
    {"title": "Fish and Chips", "steps": "1. Preparar masa para rebozar\n2. Freír el pescado\n3. Cortar y freír papas\n4. Servir con salsa tártara", "image": "https://images.unsplash.com/photo-1579208030886-b1a5b76f87a4?w=600&q=80", "difficulty": difficultyEnum.MEDIUM, "prep_time": 40, "portions": 4, "ingredients": [("Pescado blanco", 600, "g"), ("Papa", 800, "g"), ("Harina", 200, "g")]},
    ...
    {"title": "Pollo Teriyaki", "steps": "1. Marinar el pollo\n2. Saltear en sartén\n3. Añadir salsa teriyaki\n4. Servir con arroz", "image": "https://images.unsplash.com/photo-1609183480237-ccf9c8a667e7?w=600&q=80", "difficulty": difficultyEnum.EASY, "prep_time": 30, "portions": 4, "ingredients": [("Pollo", 500, "g"), ("Salsa teriyaki", 100, "ml"), ("Arroz", 300, "g")]},
